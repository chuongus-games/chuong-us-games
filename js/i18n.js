  ...
  const DICT = {
    ...
    en: {
      ...
      index: {
        ...
        heroP: 'New games show up all the time, no install needed. Click, play, done. Think you can clear all of them? 🔥',
        cta: 'PLAY NOW',
        introP: 'Chuong US Games is a free pile of hard games, no download, no signup, just click and go. Ten seconds is enough to learn any of them: tapping past pipes, dodging bullets, training your aim, testing reaction speed, memory, a maze, and a bunch more. Almost nobody beats their own best score twice in a row. If you want something that actually tests your reflexes and your patience, pick one below.',
        searchPlaceholder: '🔍 Search games… (e.g. flappy, aim, maze)', faqTitle: 'Frequently asked questions',
        faq1Q: 'What makes these games hard?',
        faq1A: 'Every rule here fits in one line. What makes it hard is the timing, the precision, the reflex window underneath. Most people don\'t beat their own best score in the first few tries, and that\'s kind of the point.',
        faq2Q: 'Are the hard games free to play?',
        faq2A: 'Yeah, every game is free, no download, no signup. A free account just unlocks the leaderboard, nothing is locked behind a paywall.',
        faq3Q: 'Do I need to download anything to play?',
        faq3A: 'Nothing to download. It runs straight in your browser, phone or desktop, doesn\'t matter which.',
        ...
        card: {
          ...
          dodge: 'Guide the blue square through spinning bullets to the goal. One touch, and you\'re back at the start.',
          reaction: 'Click the instant the screen turns green. Under 200ms is the only score that counts.',
          timer: 'Stop the clock at exactly 1.000 seconds. Off by a millisecond, and it counts as a loss.',
          ...
          stack: 'Stack blocks with perfect timing. Any overhang gets sliced off, and running out of block means the tower\'s done.',
          aim: 'Hit 20 shrinking targets as fast as you can. Every miss adds a penalty.',
          maze: 'Trace your cursor through a narrow corridor to the goal. Touch a wall, and you\'re right back at start.',
          runner: 'Jump over spikes at ever-increasing speed. How far can you run?',
          colorrush: 'Tap only when the card matches the target color. One wrong tap breaks your streak just as fast as one miss.',
          numrush: 'Tap 1 to 25 in order as fast as you can. Every wrong tap costs you a second.',
          serpent: 'Steer a growing snake around a 20x20 grid. Every bite makes it faster, and one wrong turn is all it takes.',
          keystrike: 'Type each falling word before it hits the bottom line. Speed keeps climbing, and a single missed word breaks the run.',
          siege: 'Weave through bullets fired at you from every direction at once. Survive one second at a time.',
          breaker: 'Bounce the ball and clear every brick. Boards refill faster each time, so one miss is all it costs you.',
          slice: 'Swipe to slice glowing orbs before they fall. Slice a bomb by mistake and that\'s the run, right there.',
          ...
          catch: 'Slide the bucket to catch only the target color. Grab one wrong color and that\'s it, run\'s done.',
          voidjumper: 'Charge, aim, and leap between crumbling platforms while the void scrolls up faster every second.',
          laneswitch: 'Slide between 3 lanes to dodge oncoming blocks. Speed never stops climbing, and sometimes only one lane stays open.',
          tiltbalance: 'Tilt a shrinking platform to keep the ball rolling. Dodge the holes, and mind the edge.',
          flashgrid: 'Tap the blue cell before it fades. Touch the red trap even once and it\'s game over on the spot.',
          ...
          eyetrick: 'Tap the true ink color, not the word. Classic Stroop-effect trap, with a timer that keeps shrinking.',
          focuslock: 'Track one glowing dot as it blends into an identical swarm and bounces around. Lose sight of it, and the round\'s done.',
    ...
    vi: {
      ...
      index: {
        ...
        heroP: 'Trò chơi mới cứ ra liên tục, khỏi cài đặt gì hết. Bấm là chơi liền. Bạn nghĩ mình chơi hết nổi hông? 🔥',
        cta: 'CHƠI NGAY',
        introP: 'Chuong US Games là một đống trò chơi khó, chơi miễn phí, khỏi tải khỏi đăng ký, cứ bấm vô là chơi. Mười giây là học được hết trơn: chạm bay qua ống, né đạn, luyện ngắm, test phản xạ, thử trí nhớ, đi mê cung, còn nhiều nữa. Vậy mà gần như hổng ai qua được điểm cao nhất của chính mình hai lần liên tiếp. Muốn thử thách phản xạ với sự kiên nhẫn thiệt sự thì chọn đại một trò bên dưới đi.',
        searchPlaceholder: '🔍 Tìm trò chơi… (vd: flappy, aim, maze)', faqTitle: 'Câu hỏi thường gặp',
        faq1Q: 'Điều gì khiến các trò chơi này khó?',
        faq1A: 'Luật chơi ở đây gói gọn trong một dòng hết. Cái khó nằm ở chỗ canh giờ, độ chính xác, cửa sổ phản xạ ẩn phía sau. Đa số chơi mấy lần đầu là chưa qua nổi điểm cao nhất của chính mình, mà đó cũng là cái thú vị của nó.',
        faq2Q: 'Các trò chơi khó này có miễn phí không?',
        faq2A: 'Ừ, miễn phí hết, khỏi tải khỏi đăng ký. Tạo tài khoản miễn phí chỉ để mở bảng xếp hạng thôi, hổng có gì bị khóa sau tường phí đâu.',
        faq3Q: 'Tôi có cần tải gì để chơi không?',
        faq3A: 'Khỏi tải gì hết. Chạy thẳng trên trình duyệt, điện thoại hay máy tính đều được, hổng quan trọng.',
        footer: '© 2026 Chuong.us | chuonglife@gmail.com',
        card: {
